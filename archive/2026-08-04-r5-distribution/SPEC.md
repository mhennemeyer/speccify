...
code-complete 2026-08-02 (Sidecars, Engine-Payload, uv, Signing-Vorbereitung, Updater, Download-Seite) — offen nur BO-Aktionen: Developer-ID-Zertifikat (R5.3), Updater-Schlüssel erzeugen (R5.4), dotagent-Repo archivieren (R5.5)
