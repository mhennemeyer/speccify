---
title: "Komponenten-API, Komposition & Mocks (Spec-Schema v1)"
description: "Seit dem OSS-Pivot P2 hat jede Spec einen **formalen API-Vertrag** (`api:`) und kann aus Unterkomponenten **komponiert** werden (`composition:`). Aus dem API-Vertrag generiert `speccify mock` **deterministische Mock-Komponenten** — ohne LLM, ohne Netz. Mocks sind die Render-Grundlage des visuellen Composers (Phase P3)."
---
...
- Ganze Projekte aus Specs: [`app-builds.md`](/app-builds/) (`kind: app`, `speccify build`)
...
- Conformance/Build-Smoke: [`conformance.md`](/conformance/)
