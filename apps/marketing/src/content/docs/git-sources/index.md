---
title: "Git repositories as playbook sources"
description: "Playbooks are shared like Go modules or SwiftPM packages: **the repository URL is the identity, tags are the versions**. Nothing central hands out names, there is no login and no publish upload — releasing is `git tag` + `git push`."
---
...
- Playbook format: [`playbooks.md`](https://github.com/mhennemeyer/speccify/blob/main/docs/playbooks.md)
