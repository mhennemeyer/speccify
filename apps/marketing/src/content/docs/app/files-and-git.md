...
path**. When the agent changes a file you have open but did not touch,
it reloads.
...
Click a file for its **diff** in the middle; the inspector names its
state and offers **Stage**, **Open in editor**, and **Diff as prompt**.
...
The last twenty commits are listed under the diff. Without a
