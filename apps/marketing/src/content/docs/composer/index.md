---
title: "Visueller Composer (P3, MVP)"
description: "Der Composer ist ein **visueller Spec-Editor**: Komponenten aus der Registry werden auf einem Canvas zu **Composite-Komponenten oder Apps** komponiert — gerendert als interaktive Mocks, verdrahtet per typgeprüfter Wiring, gespeichert als ganz normale `speccify.yaml` (Round-Trip, kein eigenes Dateiformat)."
---
...
die CLI. Details: [`git-sources.md`](/git-sources/).
...
- Routen für `kind: app` gibt es (Phase P4, siehe [`app-builds.md`](/app-builds/)), der Composer editiert sie aber noch nicht visuell — sie stehen im YAML.
...
- Projekt-Builds: [`app-builds.md`](/app-builds/)
