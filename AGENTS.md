...
**Phase 3 aktiv — zweites + drittes Codegen-Target + Conformance-Runner + Workspaces (Skelett).** Plan: [`.agent/plans/phase-3-codegen-targets.md`](./.agent/plans/phase-3-codegen-targets.md) — Stage 0 = Klärung der 10 Open Questions (zweites/drittes Target, Conformance-Runner-Stack, Workspaces-Lockfile-Layout, Multi-Target-Manifest, …), bevor Round-2 Delivery-Steps konkretisiert werden.
