...
- Builds on [mcp-client-streamable-http](../mcp-client-streamable-http/SKILL.md).
- Tool [verify-stream](../../tools/verify-stream/TOOL.md) — implemented for this platform in `.agent/tools/verify-stream/`; see the examples there for the contract.
