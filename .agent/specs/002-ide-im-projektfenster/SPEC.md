...
- [x] I1 Dateibaum + CodeMirror-Editor
- [x] I2 Git über System-git (Status, Diff, Stagen, Commit, Log, Pull/Push)
- [x] I3 Hunk-Staging, Datei-Historie, Commit-Details, Branches, Verwerfen
- [x] I3 Toolbar konfigurierbar (eingebaute Knöpfe + Aktionen)
- [x] I3 Projektsuche, Blame am Rand, pfad:zeile-Links, Dateien anlegen/umbenennen/löschen, Zuletzt geöffnet
- [ ] BO-Prüfung in der echten App (Terminal-Link, Papierkorb, Hunks)

## Stand bei der Migration (2026-09-09)

I1 + I2 geliefert (2026-09-06); I3-Kern geliefert 2026-09-09 (BO-Auftrag „Aktionen, konfigurierbare Toolbar, Git vollständig, Datei-Historie im Inspektor, Inspektor-Tabs") — Hunk-Staging, Verwerfen, Commit-Details, Branches, Datei-Historie in Git- und Dateien-Inspektor, Toolbar-Knöpfe (eingebaut + Aktionen) wählbar und sortierbar; I3-Rest ebenfalls 2026-09-09: Projektsuche (ripgrep-Bausteine), Blame-Gutter, pfad:zeile-Links im Terminal, Dateien anlegen/umbenennen/löschen (Papierkorb) — I3 komplett, es bleibt „Zuletzt geöffnet je Projekt" und Tastaturkürzel für den Editor
