...
│   ├── Frage-Box im Inspektor (065): Markdown mit Absätzen/Listen/Code, „Kopieren“ an jedem Backtick-Stück und Codeblock („✓ kopiert“), Antworten ebenso
...
| [065 Fragen lesbar/kopierbar](../specs/065-fragen-lesbar-kopierbar/SPEC.md) | Done (2026-09-22) | `QuestionText.tsx`: Fragen/Antworten als Markdown (harte Umbrüche), Inline-Code und Blöcke mit Kopierknopf (Clipboard-Plugin), Suite `test_spec_questions`; Release 0.8.6 |
| [067 GitLab-Deploy-Key-Skill](../specs/067-gitlab-deploy-key-skill/SPEC.md) | Doing (2026-09-22, wartet auf BO-`apply`) | Skill `gitlab-deploy-key` + Tool (`macos.py`/`linux.py`, plan/check/apply, GitLab API v4, Token nur aus `GITLAB_TOKEN`), `tool check` verified, Katalogmodul `agent-knowledge`; erster Einsatz AVC/rekas 008 Q1 |
| [066 Release 0.8.6](../specs/066-release-086/SPEC.md) | Done (2026-09-22) | Tag `v0.8.6`, CI und sechs Release-Jobs im ersten Lauf grün, 20 Assets, Manifest gegen lokalen Nachbau geprüft, veröffentlicht, Update 0.8.5→0.8.6 über den Updater |
