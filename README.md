...
- [`docs/visual-regression.md`](./docs/visual-regression.md) — **Phase 5c Skeleton**: Visual-Regression via Playwright + pixelmatch (React/Angular Skeleton-Driver, 10 % Default-Tolerance, eigener CI-Workflow `visual-regression.yml`, Opt-in via `pytest -m visual_regression`).
